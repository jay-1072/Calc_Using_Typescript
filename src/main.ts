...
let _memoryClear = document.querySelector('#mc') as HTMLButtonElement;
let _memoryRestore = document.querySelector('#mr') as HTMLButtonElement;
let _memoryShow = document.querySelector('#m') as HTMLButtonElement;
let _memoryTable = document.getElementById('memory') as HTMLDivElement;
let _sqr = document.getElementById('sqr') as HTMLAnchorElement;
let _root = document.getElementById('root') as HTMLAnchorElement;
let _expo = document.getElementById('expo') as HTMLAnchorElement;
let _tenpow = document.getElementById('tenpow') as HTMLAnchorElement;
let _log = document.getElementById('log') as HTMLAnchorElement;
let _ln = document.getElementById('ln') as HTMLAnchorElement;
let btntxt = document.getElementById("btntxt") as HTMLAnchorElement;
let btncheck = document.getElementById("btn-check") as HTMLDivElement;
let marr:number[] = [];
let op:string[] = ['+', '-', '*', '/', '%', '.'];
let otherInput:string[] = ["(", ")", "Backspace"];
/*************************************************************************************************************************************************** */
...
window.onkeydown = (e) => { 
    ...
    switch (x) { 
        ...
        case "Backspace": pop(); 
        break; 
        case "e": display(Math.E.toString()); 
        break; 
        case "p": display(Math.PI.toString()); 
        break; 
        case "s": sin(); 
        break; 
        case "c": cos(); 
...
function disableMemory(state:boolean) {
...
function inv_RAD_DEG(val:number) {
